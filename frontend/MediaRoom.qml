        ...
        Rectangle { //media controls container
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    // Replace your metadata section with this scrolling version
                    ColumnLayout {
                        Layout.fillWidth: true
                        Layout.alignment: Qt.AlignHCenter
                        Layout.preferredWidth: parent.width * 0.7
                        spacing: App.Spacing.mediaRoomMetaSpacing
                        ...
                        Item {
                            ...
                            Flickable {
                                ...
                                Text {
                                    ...
                                    font.bold: true
                                    // No elide here since we want to scroll
                                }
                                
                                // Auto-scroll animation if text is wider than container
                                Timer {
                                    id: songScrollTimer
                                    interval: 3000 // Wait time before scrolling starts
                                    running: songTitleText.width > songTitleFlickable.width
                                    repeat: true
                                    onTriggered: {
                        ...
                        // Artist and album info with scrolling
                        Item {
                            Layout.fillWidth: true
                            height: App.Spacing.mediaRoomMetaDataBandText + 10 // Some extra padding
                            ...
                            Flickable {
                                ...
                                // Auto-scroll animation if content is wider than container
                                Timer {
                                    id: metadataScrollTimer
                                    interval: 3000 // Wait time before scrolling starts
                                    running: metadataRow.width > metadataFlickable.width
                                    repeat: true
                                    onTriggered: {
                ...
                Rectangle { // Right side - Album Art
                    ...
                    Layout.preferredWidth: parent.width * 0.3  // Fixed 30% allocation
                    Layout.maximumWidth: parent.width * 0.3    // Maximum width constraint
                    Layout.minimumWidth: parent.width * 0.3    // Add minimum width constraint
                    color: transparentColor
                    clip: false
