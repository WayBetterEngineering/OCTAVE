        ...
        Rectangle { //media controls container
            ...
            RowLayout {
                ...
                Rectangle { // Right side - Album Art
                    ...
                    Layout.maximumWidth: parent.width * 0.3 // Add a maximum width constraint
                    Layout.preferredWidth: Math.min(App.Spacing.mediaRoomAlbumArtWidth, parent.width * 0.3)
                    color: transparentColor
                    clip: false // Changed to false to allow shadow to extend outside
